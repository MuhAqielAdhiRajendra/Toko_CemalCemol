...
<head>
    ...
    <title>Create Account - CemalCemol.</title>
...
<body class="bg-base min-h-screen flex justify-center items-center py-10 selection:bg-primary selection:text-white">
    ...
    <div class="bg-surface p-8 rounded-lg shadow-sm border border-border w-96">
        <div class="text-center mb-6">
            ...
            <h2 class="text-lg font-medium text-primary">Create an account</h2>
        </div>
        ...
        <form action="{{ route('register.post') }}" method="POST">
            ...
            <div class="mb-4">
                <label class="block text-secondary font-medium mb-2 text-xs uppercase tracking-wider">Full Name</label>
                <input type="text" name="name" class="w-full p-2.5 bg-surface text-primary border border-border rounded-md focus:outline-none focus:border-primary transition" required>
            </div>

            <div class="mb-4">
                <label class="block text-secondary font-medium mb-2 text-xs uppercase tracking-wider">Email</label>
                <input type="email" name="email" class="w-full p-2.5 bg-surface text-primary border border-border rounded-md focus:outline-none focus:border-primary transition" required>
            </div>

            <div class="mb-4">
                <label class="block text-secondary font-medium mb-2 text-xs uppercase tracking-wider">Password</label>
                <input type="password" name="password" class="w-full p-2.5 bg-surface text-primary border border-border rounded-md focus:outline-none focus:border-primary transition" required>
            </div>
            
            <div class="mb-6">
                <label class="block text-secondary font-medium mb-2 text-xs uppercase tracking-wider">Confirm Password</label>
                <input type="password" name="password_confirmation" class="w-full p-2.5 bg-surface text-primary border border-border rounded-md focus:outline-none focus:border-primary transition" required>
            </div>
        ...
        <div class="mt-6 text-center border-t border-border pt-4">
            <p class="text-xs text-secondary mb-1">Already have an account?</p>
            <a href="{{ route('login') }}" class="text-primary font-medium hover:text-black transition">Sign in here</a>
        </div>
    </div>
