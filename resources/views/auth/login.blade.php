...
<body class="bg-pink-50 h-screen flex justify-center items-center">
    ...
    <div class="bg-white p-8 rounded-2xl shadow-xl border border-pink-100 w-96">
        <div class="text-center mb-6">
            ...
            <h2 class="text-xl font-bold text-gray-800">Login ke Akun Anda</h2>
        </div>
        ...
        <form action="{{ route('login.post') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="email" name="email" class="w-full p-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-300 focus:border-pink-500 transition" placeholder="user@toko.com" required>
            </div>

            <div class="mb-4">
                <label class="block text-gray-700 font-bold mb-2 text-sm">Password</label>
                <input type="password" name="password" class="w-full p-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-300 focus:border-pink-500 transition" placeholder="********" required>
            </div>
        ...
        <div class="mt-6 text-center border-t border-pink-100 pt-4">
            <p class="text-sm text-gray-600 mb-1">Belum punya akun?</p>
            <a href="{{ route('register') }}" class="text-pink-600 font-bold hover:text-pink-700 hover:underline transition">Daftar Sekarang</a>
        </div>

        <div class="mt-2 text-center">
            <a href="/" class="text-sm text-gray-500 hover:text-pink-600 transition">← Kembali ke Toko</a>
        </div>
    </div>
