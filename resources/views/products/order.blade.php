    ...
    <div class="max-w-7xl mx-auto p-6 lg:p-10">
        ...
        <div class="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
            <div>
                ...
                <p class="text-gray-500 text-sm mt-1">Kelola semua pesanan masuk di sini, wak.</p>
            </div>
            
            <div class="flex gap-4">
                <div class="bg-white p-4 rounded-xl shadow-sm border border-pink-100 flex items-center gap-3">
                    ...
                    <tbody class="divide-y divide-gray-100">
                                    ...
                                    <div class="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
                                        <div class="relative transform overflow-hidden rounded-2xl bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-4xl border border-pink-100">
                                            ...
                                            <div class="bg-pink-600 px-6 py-4 flex justify-between items-center">
                                                ...
                                                <button onclick="closeModal('modal-{{ $order->id }}')" class="text-pink-100 hover:text-white text-2xl font-bold">&times;</button>
                                            </div>
                                            ...
                                            <div class="px-6 py-6 bg-gray-50 grid grid-cols-1 md:grid-cols-3 gap-6">
                                                ...
                                                <div class="space-y-6">
                                                    ...
                                                    <div class="bg-pink-50 p-4 rounded-xl border border-pink-100">
                                                        <h4 class="text-sm font-bold text-gray-700 uppercase mb-3">⚙️ Update Status</h4>
                        ...
                        <tr>
                            <td colspan="6" class="p-10 text-center text-gray-500">
                                Belum ada pesanan masuk wak. Santai dulu ☕
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
